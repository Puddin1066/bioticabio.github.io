 ...
 */
export async function runIntegratedPipeline(provider, request, artifactDir) {
    ...
    if (drugResolved)
        resolvedEntities.drug = drugResolved;
    if (diseasesResolved.length)
        resolvedEntities.diseases = diseasesResolved;
    if (targetsResolved.length)
        resolvedEntities.targets = targetsResolved;
