 ...
 */
export function buildIntegratedReportMarkdown(data, baseUrl = '', audience) {
 ...
 */
export function buildIntegratedReportSections(data, audience) {
    const meta = data._meta ?? {};
    const drug = data.drug;
    const diseases = data.diseases;
    const targets = data.targets;
...
//# sourceMappingURL=buildIntegratedReport.js.map