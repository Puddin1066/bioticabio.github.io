...
type Disease = {
  ...
  knownDrugs?: { count?: number; rows?: Array<{ drugId?: string; prefName?: string; phase?: string; target?: { approvedSymbol?: string; approvedName?: string }; targetId?: string }> };
  associatedTargets?: { count?: number; rows?: Array<{ score?: number; target?: { approvedSymbol?: string; approvedName?: string } }> };
};
type Meta = {
  dryEyeEfoIds?: string[];
 ...
 */
export function buildDryEyeSection(
  diseases: Record<string, Disease> | null | undefined,
  meta?: Meta | null
): string {
